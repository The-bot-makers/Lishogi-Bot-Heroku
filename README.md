...
- Fairy Stockfish 13 POPCNT + SSE41 (Modern CPU)
...
- Then `Enable Automatic Deploys` and then select the `main` branch (which is already done by default) and Click `Deploy`.
